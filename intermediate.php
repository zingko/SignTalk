...
<h1 class="heading"> Intermediate </h1>
...
$sql = "SELECT * FROM course WHERE courseLevel = 'Intermediate'";
...
$progressSql = "SELECT c.courseID, c.courseName, 
                ...
                WHERE c.courseLevel = 'Intermediate'
...
if ($progressResult === false) {
    ...
    // Fetch courses
    $courses = [];
    $courseSql = "SELECT * FROM course WHERE courseLevel = 'Intermediate'";
